<?php
    ...
    function inserirFabricante(PDO $conexao, string $nome):void {
        // Insere no Bando de dados o valor digitado pelo usuário no formulário armazenado na vriável $nome
        ...
        try {
            ...
            // bindParam('nome do parametro', $variável_com_valor, constante de verificação)
